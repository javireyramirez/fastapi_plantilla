...
__all__ = ["get_rbac_service", "require_permission", "require_sse_permission"]
...
def require_sse_permission(
    module_code: str, action: RbacActions
) -> Callable[..., Coroutine[Any, Any, ScopeContext]]:
    """FastAPI dependency enforcing RBAC permissions snapshot for SSE endpoints."""

    async def _sse_permission_checker(
    ...
    return _sse_permission_checker
